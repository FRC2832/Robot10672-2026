...
public class Eject extends Command {
    ...
    public void initialize() {
        fuelSubsystem.setIntakeLauncherRoller(
                -1.0 * SmartDashboard.getNumber("Intaking intake roller value", FuelConstants.INTAKING_INTAKE_VOLTAGE));
        fuelSubsystem.setFeederRoller(
                -1.0 * SmartDashboard.getNumber("Intaking feeder roller value", FuelConstants.INTAKING_FEEDER_VOLTAGE));
    }
